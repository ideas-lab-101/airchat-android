...
public class HandleReceiverNotificationOpened implements BaseHandleListener {
    ...
    public void goNextByFront(Context mContext) {
        ...
        intent.setClassName(mContext.getPackageName(), "com.android.crypt.chatapp.MainActivity");
    ...
    public void goNextByBackground(Context context) {
        Intent launchIntent = context.getPackageManager().getLaunchIntentForPackage("com.chatapp.push");
