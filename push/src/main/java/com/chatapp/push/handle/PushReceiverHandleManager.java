package com.chatapp.push.handle;
...
import com.chatapp.push.handle.impl.HandleReceiverAlias;
import com.chatapp.push.handle.impl.HandleReceiverMessage;
import com.chatapp.push.handle.impl.HandleReceiverNotification;
import com.chatapp.push.handle.impl.HandleReceiverNotificationOpened;
import com.chatapp.push.handle.impl.HandleReceiverRegistration;
...
import static com.chatapp.push.util.PushRunningData.CallBacKType.pushIsOpened;
...
public class PushReceiverHandleManager {
    ...
    private String mAlias = PushRunningData.getInstance().getAlias(); //别名
     ...
     * 执行别名设置
     */
    public void doSetAlias(Context context, ReceiverInfo registerInfo) {
    ...
    public void onNotificationOpened(Context context, ReceiverInfo info) {
        ...
        PushRunningData.getInstance().callBackOpened(PushRunningData.CallBacKType.pushIsOpened);
    }
