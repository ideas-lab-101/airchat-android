...
import com.chatapp.push.target.huawei.HuaweiInit;
import com.chatapp.push.target.jiguang.JPushInit;
import com.chatapp.push.target.meizu.MeizuInit;
import com.chatapp.push.target.oppo.OppoInit;
import com.chatapp.push.target.xiaomi.XiaomiInit;
...
//        }
        ...
        try{
            ...
            PushReceiverHandleManager.getInstance().doSetAlias(context, null);
        }catch (Exception e){}
    ...
    public void setForeground(Application context, boolean isForeground){
        //***记录前后胎状态
        PushRunningData.getInstance().setIsForeground(isForeground);
    }
