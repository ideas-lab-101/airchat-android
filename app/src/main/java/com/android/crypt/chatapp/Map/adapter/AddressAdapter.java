package com.android.crypt.chatapp.Map.adapter;
...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyHolder> {
    ...
    public AddressAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyHolder myHolder = new MyHolder(LayoutInflater.from(mContext).inflate(R.layout.map_item_address_info, parent, false));
        return myHolder;
    }
