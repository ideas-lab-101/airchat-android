...
public class UpdateService extends Service {
    ...
    private static Intent installIntent(String path){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(ChatAppApplication.getContext(), "com.android.crypt.chatapp", new File(path));
    ...
    private static class DownloadApk extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (DEBUG){
                Logger.d( "download url is " + downloadUrl);
                Logger.d("download apk cache at " + file.getAbsolutePath());
            }
